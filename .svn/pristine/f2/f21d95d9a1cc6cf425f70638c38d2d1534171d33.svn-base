...
import com.microsoft.hsg.android.simplexml.things.types.base.LabTestResultsData;
import com.microsoft.hsg.android.simplexml.things.types.base.NutritionInformation;
import com.microsoft.hsg.android.simplexml.things.types.base.UnitConversions;
