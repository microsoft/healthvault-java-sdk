...
allowing a user to view and add weight measurements.  The UI is built 
on simple servlets and JSP. 
...
Building:
    ...
    from your build above located at ui/target/jwildcat-1.4-ui.*.*-SNAPSHOT.war
