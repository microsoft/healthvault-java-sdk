 ...
 * 
 * 
 * <p>Java class for plan-outcome-list complex type.
 * 
 ...
 *       &lt;sequence>
 *         &lt;element name="outcome" type="{urn:com.microsoft.wc.thing.plan}plan-outcome" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "plan-outcome-list", namespace = "urn:com.microsoft.wc.thing.plan", propOrder = {
    "outcome"
})
public class PlanOutcomeList {

    @XmlElement(required = true)
    protected List<PlanOutcome> outcome;
     ...
     * 
     */
    public List<PlanOutcome> getOutcome() {
        if (outcome == null) {
            outcome = new ArrayList<PlanOutcome>();
        }
        return this.outcome;
    }
