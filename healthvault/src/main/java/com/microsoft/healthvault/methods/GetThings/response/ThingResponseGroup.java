...
package com.microsoft.healthvault.methods.GetThings.response;
...
@XmlType(name = "ThingResponseGroup", namespace = "urn:com.microsoft.wc.methods.response.GetThings", propOrder = {
    "thing",
