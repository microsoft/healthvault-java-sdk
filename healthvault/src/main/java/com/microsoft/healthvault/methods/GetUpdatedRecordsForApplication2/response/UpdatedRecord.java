...
@XmlType(name = "UpdatedRecord", namespace = "urn:com.microsoft.wc.methods.response.GetUpdatedRecordsForApplication2", propOrder = {
    "recordId",
    "updateDate",
    "personId",
...
public class UpdatedRecord {
    ...
    @XmlElement(name = "latest-operation-sequence-number")
