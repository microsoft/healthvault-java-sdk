...
@XmlType(name = "UserInitiatedCreationUsingEmail", namespace = "urn:com.microsoft.wc.methods.AuthorizeRecord", propOrder = {
    "emailAddress",
    "granteeName",
    "emailText",
    "expiresDate",
...
public class UserInitiatedCreationUsingEmail {
    ...
    @XmlElement(name = "expires-date", required = true)
    ...
    protected int relId;
    @XmlElement(name = "requesting-application-id")
    protected String requestingApplicationId;
    protected String pin;
    @XmlElement(name = "invitation-expires-date")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar invitationExpiresDate;
     ...
     *     
     */
    public XMLGregorianCalendar getInvitationExpiresDate() {
     ...
     *     
     */
    public void setInvitationExpiresDate(XMLGregorianCalendar value) {
