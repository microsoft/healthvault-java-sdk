...
import com.microsoft.healthvault.thing.AccessAvenue;
...
@XmlType(name = "RecordAudit", namespace = "urn:com.microsoft.wc.methods.response.GetRecordAudit", propOrder = {
    "recordId",
    "personId",
    "applicationId",
...
public class RecordAudit {
    ...
    @XmlElement(name = "impersonating-person-id")
