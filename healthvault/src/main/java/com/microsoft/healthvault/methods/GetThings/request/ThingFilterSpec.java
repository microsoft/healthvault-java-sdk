...
import com.microsoft.healthvault.thing.ThingState;
...
@XmlType(name = "ThingFilterSpec", namespace = "urn:com.microsoft.wc.methods.GetThings", propOrder = {
    "typeId",
    "thingState",
    "effDateMin",
    "effDateMax",
...
public class ThingFilterSpec {
    ...
    @XmlElement(name = "updated-end-date-max")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar updatedEndDateMax;
    @XmlElement(name = "updated-end-date-min")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar updatedEndDateMin;
     ...
     *     
     */
    public XMLGregorianCalendar getUpdatedEndDateMax() {
     ...
     *     
     */
    public void setUpdatedEndDateMax(XMLGregorianCalendar value) {
     ...
     *     
     */
    public XMLGregorianCalendar getUpdatedEndDateMin() {
     ...
     *     
     */
    public void setUpdatedEndDateMin(XMLGregorianCalendar value) {
