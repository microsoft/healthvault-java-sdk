...
@XmlType(name = "VocabularyParameters", namespace = "urn:com.microsoft.wc.methods.GetVocabulary", propOrder = {
    "vocabularyKey",
    "fixedCulture"
})
public class VocabularyParameters {
    ...
    public void setVocabularyKey(List<VocabularyKey> vocabularyKey) {
