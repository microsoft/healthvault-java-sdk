 ...
 *       &lt;sequence>
 *         &lt;element name="item" type="{urn:com.microsoft.wc.methods.PutApplicationCacheItems}CacheItem" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class PutApplicationCacheItemsRequest {

    @XmlElement(required = true)
    protected List<CacheItem> item;
     ...
     * 
     */
    public List<CacheItem> getItem() {
        if (item == null) {
            item = new ArrayList<CacheItem>();
        }
        return this.item;
    }
