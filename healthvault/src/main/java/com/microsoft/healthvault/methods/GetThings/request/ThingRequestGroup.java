...
/**
 * <p>Java class for ThingRequestGroup complex type.
 * 
 ...
 *         &lt;element name="format" type="{urn:com.microsoft.wc.methods.GetThings}ThingFormatSpec"/>
...
@XmlType(name = "ThingRequestGroup", namespace = "urn:com.microsoft.wc.methods.GetThings", propOrder = {
    "id",
    "key",
    "clientThingId",
    "filter",
...
public class ThingRequestGroup {
    ...
    protected ThingFormatSpec format;
     ...
     * @return
     *     possible object is
     *     {@link ThingFormatSpec }
     *     
     */
    public ThingFormatSpec getFormat() {
        return format;
    }
     ...
     *     
     */
    public void setFormat(ThingFormatSpec value) {
        this.format = value;
    }
