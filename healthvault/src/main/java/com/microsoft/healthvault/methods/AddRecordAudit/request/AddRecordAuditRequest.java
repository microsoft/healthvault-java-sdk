 ...
 *       &lt;sequence>
 *         &lt;element name="record-audit" type="{urn:com.microsoft.wc.methods.AddRecordAudit}RecordAudit" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class AddRecordAuditRequest {

    @XmlElement(name = "record-audit", required = true)
