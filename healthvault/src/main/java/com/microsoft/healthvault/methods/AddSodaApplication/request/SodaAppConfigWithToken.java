...
@XmlType(name = "SodaAppConfigWithToken", namespace = "urn:com.microsoft.wc.methods.AddSodaApplication", propOrder = {
    "appCreationToken",
    "name"
})
public class SodaAppConfigWithToken {

    @XmlElement(name = "app-creation-token", required = true)
