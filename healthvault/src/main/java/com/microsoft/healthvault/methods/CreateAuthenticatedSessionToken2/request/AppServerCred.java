...
import com.microsoft.healthvault.types.Sig;
...
@XmlType(name = "AppServerCred", namespace = "urn:com.microsoft.wc.methods.CreateAuthenticatedSessionToken2", propOrder = {
    "sig",
    "hmacSig",
    "content"
})
