...
@XmlType(name = "ThingTypeInfo", namespace = "urn:com.microsoft.wc.methods.response.GetThingType", propOrder = {
    "id",
    "name",
    "uncreatable",
    "immutable",
...
public class ThingTypeInfo {
    ...
    @XmlElement(name = "updated-end-date-xpath")
    protected String updatedEndDateXpath;
    @XmlElement(name = "allow-readonly")
