 ...
 *         &lt;element name="code" type="{urn:com.microsoft.wc.types}coded-value" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "codable-value", namespace = "urn:com.microsoft.wc.types", propOrder = {
    "text",
    "code"
})
public class CodableValueDeprecated {

    @XmlElement(required = true)
    protected String text;
    protected List<CodedValueDeprecated> code;
     ...
     * 
     */
    public List<CodedValueDeprecated> getCode() {
        if (code == null) {
            code = new ArrayList<CodedValueDeprecated>();
        }
        return this.code;
    }
