...
@XmlType(name = "Record", namespace = "urn:com.microsoft.wc.types", propOrder = {
    "value"
})
public class Record {
    ...
    @XmlAttribute(name = "latest-operation-sequence-number")
    protected Long latestOperationSequenceNumber;
    @XmlAttribute(name = "record-app-auth-created-date")
    @XmlSchemaType(name = "dateTime")
    protected XMLGregorianCalendar recordAppAuthCreatedDate;
     ...
     *     
     */
    public XMLGregorianCalendar getRecordAppAuthCreatedDate() {
     ...
     *     
     */
    public void setRecordAppAuthCreatedDate(XMLGregorianCalendar value) {
