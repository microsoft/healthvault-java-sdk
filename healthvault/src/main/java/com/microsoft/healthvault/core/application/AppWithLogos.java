...
import com.microsoft.healthvault.methods.GetApplication.response.Application;
...
@XmlType(name = "AppWithLogos", namespace = "urn:com.microsoft.wc.application", propOrder = {
    "id",
    "name",
    "appAuthRequired",
    "restrictAppUsers",
...
public class AppWithLogos {
    ...
    @XmlElement(name = "meaningful-use-sources-ceiling")
