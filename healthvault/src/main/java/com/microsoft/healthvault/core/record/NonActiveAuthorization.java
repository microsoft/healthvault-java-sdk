...
package com.microsoft.healthvault.core.record;
...
@XmlType(name = "NonActiveAuthorization", namespace = "urn:com.microsoft.wc.record", propOrder = {
    "recordId",
    "emailAddress",
    "recordCustodian",
...
public class NonActiveAuthorization {
    ...
    @XmlElement(name = "grantor-person-id", required = true)
