 ...
 *       &lt;sequence>
 *         &lt;element name="address" type="{urn:com.microsoft.wc.thing.types}address" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="phone" type="{urn:com.microsoft.wc.thing.types}phone" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="email" type="{urn:com.microsoft.wc.thing.types}email" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Contact {
    ...
    @ElementList(required=false, inline=true, entry="address")
    protected ArrayList<Address> address;

    @ElementList(required=false, inline=true, entry="phone")
    protected ArrayList<Phone> phone;

    @ElementList(required=false, inline=true, entry="email")
    protected ArrayList<Email> email;
