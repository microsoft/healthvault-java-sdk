 ...
 *       &lt;sequence>
 *         &lt;element name="order-by-properties" type="{urn:com.microsoft.wc.methods.response.GetThingType}OrderByProperties" minOccurs="0"/>
 *       &lt;/sequence>
...
public class VersionInfo {
    ...
    @Element(name = "order-by-properties")
    protected OrderByProperties orderByProperties;
    @Element(name = "version-type-id", required = true)
    protected String versionTypeId;
    @Element(name = "version-name", required = true)
    protected String versionName;
    @Element(name = "version-sequence", required = true)
    protected BigInteger versionSequence;

    /**
     * Gets the value of the orderByProperties property.
     * 
     * @return
     *     possible object is
     *     {@link OrderByProperties }
     *     
     */
    public OrderByProperties getOrderByProperties() {
        return orderByProperties;
    }

    /**
     * Sets the value of the orderByProperties property.
     * 
     * @param value
     *     allowed object is
     *     {@link OrderByProperties }
     *     
     */
    public void setOrderByProperties(OrderByProperties value) {
        this.orderByProperties = value;
    }
