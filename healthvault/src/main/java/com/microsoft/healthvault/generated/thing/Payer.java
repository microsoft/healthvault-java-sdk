...
import com.microsoft.healthvault.generated.types.Contact;
...
public class Payer {
    ...
    @Element(name = "plan-name", required = true)
    protected String planName;
    @Element(name = "coverage-type")
    protected CodableValue coverageType;
    @Element(name = "carrier-id")
    protected String carrierId;
    @Element(name = "group-num")
    protected String groupNum;
    @Element(name = "plan-code")
    protected String planCode;
    @Element(name = "subscriber-id")
    protected String subscriberId;
    @Element(name = "person-code")
    protected String personCode;
    @Element(name = "subscriber-name")
    protected String subscriberName;
    @Element(name = "subscriber-dob")
