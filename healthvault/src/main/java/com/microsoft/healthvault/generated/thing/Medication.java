...
public class Medication {
    ...
    @Element(name = "prescription-duration")
    protected DurationValue prescriptionDuration;
    protected String instructions;
    @Element(name = "substitution-permitted")
