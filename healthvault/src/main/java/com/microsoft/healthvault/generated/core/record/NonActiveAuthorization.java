 ...
 * 
 * 
 * <p>Java class for NonActiveAuthorization complex type.
 * 
 ...
 *         &lt;element name="grantor-person-id" type="{urn:com.microsoft.wc.types}guid"/>
 *         &lt;element name="grantee-name" type="{urn:com.microsoft.wc.types}string255"/>
 *         &lt;element name="record-authorization-token" type="{urn:com.microsoft.wc.types}base64" minOccurs="0"/>
...
public class NonActiveAuthorization {
    ...
    @Element(name = "authorized-record-state", required = true)
    ...
    @Element(name = "date-auth-expires", required = true)
    ...
    @Element(name = "date-auth-created", required = true)
    protected Date dateAuthCreated;
    @Element(name = "date-auth-updated", required = true)
    protected Date dateAuthUpdated;
    @Element(name = "grantor-name", required = true)
    protected String grantorName;
    @Element(name = "grantor-person-id", required = true)
    protected String grantorPersonId;
    ...
    /**
     * Gets the value of the grantorPersonId property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getGrantorPersonId() {
        return grantorPersonId;
    }

    /**
     * Sets the value of the grantorPersonId property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setGrantorPersonId(String value) {
        this.grantorPersonId = value;
    }
