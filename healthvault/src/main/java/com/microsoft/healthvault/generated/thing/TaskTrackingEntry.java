...
public class TaskTrackingEntry {
    ...
    @Element(name = "tracking-time", required = true)
    protected DateTime trackingTime;
    @Element(name = "tracking-type", required = true)
    protected TaskTrackingType trackingType;
    @Element(name = "tracking-status", required = true)
    protected TaskTrackingStatus trackingStatus;
    @Element(name = "occurrence-start-time")
    protected DateTime occurrenceStartTime;
    @Element(name = "occurrence-end-time")
    protected DateTime occurrenceEndTime;
    @Element(name = "completion-start-time", required = true)
    protected DateTime completionStartTime;
    @Element(name = "completion-end-time", required = true)
