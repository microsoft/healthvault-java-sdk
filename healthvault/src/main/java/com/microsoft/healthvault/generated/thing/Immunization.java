 ...
 *         &lt;element name="administration-date" type="{urn:com.microsoft.wc.dates}approx-date-time"/>
...
public class Immunization {
    ...
    @Element(name = "administration-date", required = true)
    ...
    @Element(name = "anatomic-surface")
    protected CodableValue anatomicSurface;
    @Element(name = "adverse-event")
