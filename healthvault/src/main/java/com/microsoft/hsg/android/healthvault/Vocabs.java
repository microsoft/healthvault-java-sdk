...
import com.microsoft.hsg.android.healthvault.methods.getvocabulary2.request.GetVocabulary2Request;
import com.microsoft.hsg.android.healthvault.methods.getvocabulary2.request.VocabGetParams;
import com.microsoft.hsg.android.healthvault.methods.getvocabulary2.response.GetVocabulary2Response;
import com.microsoft.hsg.android.healthvault.methods.getvocabulary2.response.VocabCodeSet;
import com.microsoft.hsg.android.healthvault.methods.getvocabulary2.response.VocabGetResults;
import com.microsoft.hsg.android.healthvault.methods.request.RequestTemplate;
import com.microsoft.hsg.android.healthvault.methods.searchvocabulary.request.SearchVocabularyRequest;
import com.microsoft.hsg.android.healthvault.methods.searchvocabulary.request.VocabSearch;
import com.microsoft.hsg.android.healthvault.methods.searchvocabulary.response.SearchVocabularyResponse;
import com.microsoft.hsg.android.healthvault.methods.searchvocabulary.response.VocabQueryResult;
import com.microsoft.hsg.android.healthvault.methods.searchvocabulary.response.VocabQueryResults;
