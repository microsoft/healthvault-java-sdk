...
import com.microsoft.hsg.methods.jaxb.getvocabulary.request.GetVocabularyRequest;
import com.microsoft.hsg.methods.jaxb.getvocabulary.request.VocabularyParameters;
import com.microsoft.hsg.methods.jaxb.getvocabulary.response.GetVocabularyResponse;
...
public class GetVocabularyTest {
    ...
    public void GetVocabulary() throws Exception
    {
    	...
    	GetVocabularyResponse response = 
    		(GetVocabularyResponse)requestTemplate.makeRequest(request);
