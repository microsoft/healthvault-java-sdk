...
public class ActionPlanInstance {
    ...
    /**
     * A URL to an image for the plan. Suggested resolution is 212x212 with a
     * 25px margin in the image.
     */
    @JsonProperty(value = "imageUrl")
    private String imageUrl;

    /**
     * A URL to a thumbnail image for the plan. Suggested resolution is 212x212
     ...
     */
    public ActionPlanInstance withId(String id) {
        this.id = id;
        return this;
    }
